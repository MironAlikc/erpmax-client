...
## Description
You can move the row by dragging it. If enableRowDrag of the column property is set to true, an icon that can be dragged to the left of the cell value is created. You can drag the icon to move the row up and down. In Selecting Row mode, you can move all the selected rows. You can receive the moved rows passed to the onRowsMoved callback.
...
## Source
Original file: `/tmp/pluto_grid_docs/demo/lib/screen/feature/row_moving_screen.dart`
