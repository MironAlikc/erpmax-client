...
## Description
Place the grid on the left and right and move or edit with the keyboard. Refer to the display property for the width of the grid. This is an example in which the right list is randomly generated whenever the current row of the left grid changes.
...
## Source
Original file: `/tmp/pluto_grid_docs/demo/lib/screen/feature/dual_mode_screen.dart`
