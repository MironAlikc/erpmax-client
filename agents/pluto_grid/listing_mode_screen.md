...
## Description
Listing mode to open or navigate to the Detail page. Press Enter or tap to call up the Detail popup. Pressing the Ctrl(Meta on MacOS) + C keys can invoke a popup to enter a new record.
...
- **mode**: Grid mode (normal, select, popup, etc.)

## Source
Original file: `/tmp/pluto_grid_docs/demo/lib/screen/feature/listing_mode_screen.dart`
