...
## Description
You can resize the column by dragging the icon to the right of the column. In autoSize mode, you must select Resize.pushAndPull mode to maintain the overall size when adjusting the column width.
...
## Source
Original file: `/tmp/pluto_grid_docs/demo/lib/screen/feature/column_resizing_screen.dart`
