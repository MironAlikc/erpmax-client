...
## Description
You can customize the menu on the right side of the column. A different menu can be displayed for each column.
...
## Source
Original file: `/tmp/pluto_grid_docs/demo/lib/screen/feature/column_menu_screen.dart`
