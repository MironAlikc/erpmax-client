# Add And Remove Column Row

## Description
You can add or delete columns, rows. Remove selected Rows is only deleted if there is a row selected in Row mode. If you are adding a new row, you can edit the cell regardless of the readOnly of column.
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        body: AddAndRemoveColumnRowScreen(),
      ),
    );
  }
}
...
## Source
Original file: `/tmp/pluto_grid_docs/demo/lib/screen/feature/add_and_remove_column_row_screen.dart`
