...
## Description
A column to enter a selection value. The sorting of the Selection column is based on the order of the Select items.
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        body: SelectionTypeColumnScreen(),
      ),
    );
  }
}
...
## Source
Original file: `/tmp/pluto_grid_docs/demo/lib/screen/feature/selection_type_column_screen.dart`
