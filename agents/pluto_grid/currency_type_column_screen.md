...
## Description
A column to enter a number as currency value.
...
## Source
Original file: `/tmp/pluto_grid_docs/demo/lib/screen/feature/currency_type_column_screen.dart`
