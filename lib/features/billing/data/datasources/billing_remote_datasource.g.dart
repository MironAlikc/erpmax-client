...
part of 'billing_remote_datasource.dart';
...
class _BillingRemoteDataSource implements BillingRemoteDataSource {
  _BillingRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= '/api/v1';
  }
  ...
  @override
  Future<HttpResponse<SubscriptionModel>> getSubscription() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<SubscriptionModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<HttpResponse<CheckoutResponseModel>> createCheckout(
    ...
    _data.addAll(body);
    final _options = _setStreamType<HttpResponse<CheckoutResponseModel>>(
