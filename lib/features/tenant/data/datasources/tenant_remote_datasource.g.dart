...
part of 'tenant_remote_datasource.dart';
...
class _TenantRemoteDataSource implements TenantRemoteDataSource {
  _TenantRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= '/api/v1';
  }
  ...
  Future<HttpResponse<List<TenantModel>>> getTenants({
    ...
    final _options = _setStreamType<HttpResponse<List<TenantModel>>>(
  ...
  @override
  Future<HttpResponse<TenantModel>> getCurrentTenant() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<TenantModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/tenants/current',
  ...
  @override
  Future<HttpResponse<TenantModel>> getTenantById(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<HttpResponse<List<TenantUserModel>>> getTenantUsers(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<List<TenantUserModel>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  @override
  Future<HttpResponse<void>> removeUser(String tenantId, String userId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
