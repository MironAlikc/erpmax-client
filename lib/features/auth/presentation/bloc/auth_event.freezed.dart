...
return logoutRequested(_that);case AuthSwitchTenantRequested() when switchTenantRequested != null:
return switchTenantRequested(_that);case _:
  return orElse();
...
return logoutRequested(_that);case AuthSwitchTenantRequested():
return switchTenantRequested(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  checkRequested,TResult Function( String email,  String password)?  loginRequested,TResult Function( String email,  String password,  String fullName,  String companyName)?  registerRequested,TResult Function()?  logoutRequested,TResult Function( String tenantId)?  switchTenantRequested,required TResult orElse(),}) {final _that = this;
switch (_that) {
case AuthCheckRequested() when checkRequested != null:
...
return registerRequested(_that.email,_that.password,_that.fullName,_that.companyName);case AuthLogoutRequested() when logoutRequested != null:
return logoutRequested();case AuthSwitchTenantRequested() when switchTenantRequested != null:
return switchTenantRequested(_that.tenantId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  checkRequested,required TResult Function( String email,  String password)  loginRequested,required TResult Function( String email,  String password,  String fullName,  String companyName)  registerRequested,required TResult Function()  logoutRequested,required TResult Function( String tenantId)  switchTenantRequested,}) {final _that = this;
switch (_that) {
case AuthCheckRequested():
return checkRequested();case AuthLoginRequested():
return loginRequested(_that.email,_that.password);case AuthRegisterRequested():
return registerRequested(_that.email,_that.password,_that.fullName,_that.companyName);case AuthLogoutRequested():
return logoutRequested();case AuthSwitchTenantRequested():
return switchTenantRequested(_that.tenantId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  checkRequested,TResult? Function( String email,  String password)?  loginRequested,TResult? Function( String email,  String password,  String fullName,  String companyName)?  registerRequested,TResult? Function()?  logoutRequested,TResult? Function( String tenantId)?  switchTenantRequested,}) {final _that = this;
switch (_that) {
case AuthCheckRequested() when checkRequested != null:
return checkRequested();case AuthLoginRequested() when loginRequested != null:
return loginRequested(_that.email,_that.password);case AuthRegisterRequested() when registerRequested != null:
...
class AuthRegisterRequested implements AuthEvent {
  const AuthRegisterRequested({required this.email, required this.password, required this.fullName, required this.companyName});
...
@override
int get hashCode => Object.hash(runtimeType,email,password,fullName,companyName);

@override
String toString() {
  return 'AuthEvent.registerRequested(email: $email, password: $password, fullName: $fullName, companyName: $companyName)';
}
...
@useResult
$Res call({
 String email, String password, String fullName, String companyName
});
...
/// Create a copy of AuthEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? email = null,Object? password = null,Object? fullName = null,Object? companyName = null,}) {
...
class AuthSwitchTenantRequested implements AuthEvent {
  const AuthSwitchTenantRequested({required this.tenantId});
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$AuthSwitchTenantRequestedCopyWith<AuthSwitchTenantRequested> get copyWith => _$AuthSwitchTenantRequestedCopyWithImpl<AuthSwitchTenantRequested>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthSwitchTenantRequested&&(identical(other.tenantId, tenantId) || other.tenantId == tenantId));
}
...
@override
String toString() {
  return 'AuthEvent.switchTenantRequested(tenantId: $tenantId)';
}
...
/// @nodoc
abstract mixin class $AuthSwitchTenantRequestedCopyWith<$Res> implements $AuthEventCopyWith<$Res> {
  factory $AuthSwitchTenantRequestedCopyWith(AuthSwitchTenantRequested value, $Res Function(AuthSwitchTenantRequested) _then) = _$AuthSwitchTenantRequestedCopyWithImpl;
@useResult
$Res call({
 String tenantId
});
...
/// @nodoc
class _$AuthSwitchTenantRequestedCopyWithImpl<$Res>
    implements $AuthSwitchTenantRequestedCopyWith<$Res> {
  _$AuthSwitchTenantRequestedCopyWithImpl(this._self, this._then);

  final AuthSwitchTenantRequested _self;
  final $Res Function(AuthSwitchTenantRequested) _then;

/// Create a copy of AuthEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? tenantId = null,}) {
  return _then(AuthSwitchTenantRequested(
