...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( UserEntity user,  List<UserTenantEntity> tenants,  TenantEntity currentTenant)?  authenticated,TResult Function()?  unauthenticated,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case AuthInitial() when initial != null:
return initial();case AuthLoading() when loading != null:
return loading();case AuthAuthenticated() when authenticated != null:
return authenticated(_that.user,_that.tenants,_that.currentTenant);case AuthUnauthenticated() when unauthenticated != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( UserEntity user,  List<UserTenantEntity> tenants,  TenantEntity currentTenant)  authenticated,required TResult Function()  unauthenticated,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case AuthInitial():
return initial();case AuthLoading():
return loading();case AuthAuthenticated():
return authenticated(_that.user,_that.tenants,_that.currentTenant);case AuthUnauthenticated():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( UserEntity user,  List<UserTenantEntity> tenants,  TenantEntity currentTenant)?  authenticated,TResult? Function()?  unauthenticated,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case AuthInitial() when initial != null:
return initial();case AuthLoading() when loading != null:
return loading();case AuthAuthenticated() when authenticated != null:
...
class AuthAuthenticated implements AuthState {
  const AuthAuthenticated({required this.user, required final  List<UserTenantEntity> tenants, required this.currentTenant}): _tenants = tenants;
  

 final  UserEntity user;
 final  List<UserTenantEntity> _tenants;
 List<UserTenantEntity> get tenants {
  if (_tenants is EqualUnmodifiableListView) return _tenants;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_tenants);
}

 final  TenantEntity currentTenant;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthAuthenticated&&(identical(other.user, user) || other.user == user)&&const DeepCollectionEquality().equals(other._tenants, _tenants)&&(identical(other.currentTenant, currentTenant) || other.currentTenant == currentTenant));
}


@override
int get hashCode => Object.hash(runtimeType,user,const DeepCollectionEquality().hash(_tenants),currentTenant);

@override
String toString() {
  return 'AuthState.authenticated(user: $user, tenants: $tenants, currentTenant: $currentTenant)';
}
...
@useResult
$Res call({
 UserEntity user, List<UserTenantEntity> tenants, TenantEntity currentTenant
});


$UserEntityCopyWith<$Res> get user;$TenantEntityCopyWith<$Res> get currentTenant;
...
/// Create a copy of AuthState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? user = null,Object? tenants = null,Object? currentTenant = null,}) {
