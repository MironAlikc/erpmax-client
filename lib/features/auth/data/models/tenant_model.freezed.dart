...
mixin _$TenantModel {
 ...
 String get id; String get name; String get slug; TenantStatus get status;@JsonKey(name: 'erpnext_site_url') String? get erpnextSiteUrl; Map<String, dynamic>? get settings;@JsonKey(name: 'created_at') DateTime get createdAt;@JsonKey(name: 'updated_at') DateTime get updatedAt;
...
@override
String toString() {
  return 'TenantModel(id: $id, name: $name, slug: $slug, status: $status, erpnextSiteUrl: $erpnextSiteUrl, settings: $settings, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String name, String slug, TenantStatus status,@JsonKey(name: 'erpnext_site_url') String? erpnextSiteUrl, Map<String, dynamic>? settings,@JsonKey(name: 'created_at') DateTime createdAt,@JsonKey(name: 'updated_at') DateTime updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String slug,  TenantStatus status, @JsonKey(name: 'erpnext_site_url')  String? erpnextSiteUrl,  Map<String, dynamic>? settings, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TenantModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String slug,  TenantStatus status, @JsonKey(name: 'erpnext_site_url')  String? erpnextSiteUrl,  Map<String, dynamic>? settings, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _TenantModel():
return $default(_that.id,_that.name,_that.slug,_that.status,_that.erpnextSiteUrl,_that.settings,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String slug,  TenantStatus status, @JsonKey(name: 'erpnext_site_url')  String? erpnextSiteUrl,  Map<String, dynamic>? settings, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _TenantModel() when $default != null:
return $default(_that.id,_that.name,_that.slug,_that.status,_that.erpnextSiteUrl,_that.settings,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _TenantModel extends TenantModel {
  const _TenantModel({required this.id, required this.name, required this.slug, required this.status, @JsonKey(name: 'erpnext_site_url') this.erpnextSiteUrl, final  Map<String, dynamic>? settings, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'updated_at') required this.updatedAt}): _settings = settings,super._();
...
@override@JsonKey(name: 'erpnext_site_url') final  String? erpnextSiteUrl;
